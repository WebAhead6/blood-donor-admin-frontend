...
const ChangePassword = function ({password,confirmPassword,handleClick,onPasswordChange,onConfirmPasswordChange,error}) {
  ...
  <form action="#" className="changePassword_form" onSubmit={(e)=> {e.preventDefault(); handleClick()}}>
          ...
          <input className="input" type="password" placeholder="confirm password..." name="confirmPassword" value={confirmPassword} onChange={(e) => onConfirmPasswordChange (e.target.value)} />
